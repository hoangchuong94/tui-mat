...
export default function CreateProductForm({ dataCreateProduct }: CreateProductFormProps) {
    ...
    const valueDiscount = watch('discount');
                ...
                >
                    <div className="col-span-10">
                        <div className="flex w-full items-center justify-between">
                            ...
                            <Button
                                className={`rounded-3xl ${isPending ? 'text-black' : 'bg-green-400 text-white'}`}
                    ...
                    <div className="flex flex-col space-y-2 rounded-2xl bg-slate-100 p-4 md:col-span-5 lg:col-span-6 xl:col-span-7">
                        <div>
                            <InputField
                                name="name"
                                label="Name"
                        ...
                        <div className="flex flex-1 flex-col">
                            <InputField
                                ...
                                className="min-h-32 bg-slate-200 focus:bg-white"
                    ...
                    <div className="space-y-2 md:col-span-5 lg:col-span-4 xl:col-span-3">
